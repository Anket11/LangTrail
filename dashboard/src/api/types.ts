...
export interface TrajectorySummary {
  ...
  total_tokens: number
  total_cost_usd: number
  overall_label: 'good' | 'bad' | 'needs_review' | null
...
export interface TrajectoryReview {
  ...
  session_id: string
  reviewer: string
  overall_label: 'good' | 'bad' | 'needs_review'
  failure_type: string | null
  failure_event_id: string | null
  notes: string | null
  created_at: string
...
export interface SaveTrajectoryReviewRequest {
  reviewer?: string
  overall_label: 'good' | 'bad' | 'needs_review'
  failure_type?: string | null
  failure_event_id?: string | null
...
export interface ReviewAssistSuggestion {
  suggested_label: 'good' | 'bad' | 'needs_review'
  confidence: number
  failure_type: string | null
  failure_event_id: string | null
